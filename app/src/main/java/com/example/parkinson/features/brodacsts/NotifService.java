...
//
//public class NotifService extends Service implements NotifManager.NotificationMangerInterface {
//
...
//
//
//    public void postNotification(List<Medicine> medicines, int id) {

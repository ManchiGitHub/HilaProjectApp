...
public class SingleMedicineFragment extends Fragment {
    ...
    private SingleMedicineViewModel singleMedicineViewModel;
...
//        ((MainActivity) getActivity()).mainComponent.inject(this);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        singleMedicineViewModel = new ViewModelProvider(requireActivity()).get(SingleMedicineViewModel.class);
